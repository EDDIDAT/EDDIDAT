function [h] = CallbackpopupmenuYDataNonSPEC(h, PlotWindow, YDataStr, valueSlider)
...
%             assignin('base','minValLatticeSpacing',h.(minValLatticeSpacing){valueSlider})
...
%             assignin('base','YDataphi0',YDataphi0)
