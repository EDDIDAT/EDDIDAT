function CreatDiffGUI_1920x1080()
...
set (gcf, 'units', 'normalized', 'outerposition', [0.04 0.01 0.95 0.95]);
...
'Style', 'text', ...
'Units', 'Normalized', ...
'Position', [0.003 0.955 0.25 0.04] ,...
...
'Style', 'listbox', ...
'Units', 'Normalized', ...
'Position', [0.003 0.652 0.422 0.24], ...
...
'Style', 'edit', ...
'Units', 'Normalized', ...
'Position', [0.068 0.6 0.045 0.025], ...
...
'Style', 'Pushbutton', ...
'Units', 'Normalized', ...
'Position', [0.1175 0.6 0.055 0.025], ...
...
'Style', 'edit', ...
'Units', 'Normalized', ...
'Position', [0.21275 0.6 0.045 0.025], ...
'Tag', 'defineScanName', ...
'Enable', 'on', ...
'String', '#S' ...
);
...
'Style', 'text', ...
'Units', 'Normalized', ...
'Position', [0.1775 0.6 0.0325 0.02] ,...
'HorizontalAlignment', 'left', ...
'String', 'Scan name' ...
);
...
'Style', 'text', ...
'Units', 'Normalized', ...
'Position', [0.26275 0.6 0.06 0.02] ,...
'HorizontalAlignment', 'left', ...
...
'Style', 'Pushbutton', ...
'Units', 'Normalized', ...
'Position', [0.3685 0.6 0.058 0.025], ...
...
'Style', 'listbox', ...
'Units', 'Normalized', ...
'Position', [0.003 0.42 0.422 0.15], ...
...
'Style', 'listbox', ...
'Units', 'Normalized', ...
'Position', [0.003 0.01 0.422 0.379], ...
...
'Units', 'Normalized', ...
'Position', [0.44 0.763 0.175 0.129], ...
...
'Style', 'Pushbutton', ...
'Units', 'Normalized', ...
'Position', [0.625 0.865 0.071 0.025], ...
...
'Units', 'Normalized', ...
'Position', [0.705 0.763 0.1265 0.129], ...
'ColumnWidth', {100 80}, ...
...
'Style', 'Pushbutton', ...
'Units', 'Normalized', ...
'Position', [0.625 0.83 0.06 0.025], ...
...
'Style', 'text', ...
'Units', 'Normalized', ...
'Position', [0.438 0.68 0.0375 0.02] ,...
...
'Style', 'edit', ...
'Units', 'Normalized', ...
'Position', [0.478 0.68 0.04 0.025], ...
...
'Style', 'edit', ...
'Units', 'Normalized', ...
'Position', [0.5215 0.68 0.1 0.025], ...
...
'Style', 'Pushbutton', ...
'Units', 'Normalized', ...
'Position', [0.62725 0.68 0.035 0.025], ...
'String', 'Preview', ...
...
'Style', 'edit', ...
'Units', 'Normalized', ...
'Position', [0.6665 0.68 0.15 0.025], ...
'Tag', 'previewfilename', ...
'Enable', 'on', ...
'String', '' ...
);
...
'Style', 'text', ...
'Units', 'Normalized', ...
'Position', [0.438 0.65 0.0375 0.02] ,...
'HorizontalAlignment', 'right', ...
'String', '1st Channel' ...
);
...
'Style', 'edit', ...
'Units', 'Normalized', ...
'Position', [0.478 0.65 0.04 0.025], ...
...
'Style', 'edit', ...
'Units', 'Normalized', ...
'Position', [0.5215 0.65 0.1 0.025], ...
...
'Style', 'Pushbutton', ...
'Units', 'Normalized', ...
'Position', [0.62725 0.65 0.035 0.025], ...
'String', 'Preview', ...
...
'Style', 'edit', ...
'Units', 'Normalized', ...
'Position', [0.6665 0.65 0.15 0.025], ...
...
'Style', 'text', ...
'Units', 'Normalized', ...
'Position', [0.438 0.62 0.0375 0.02] ,...
'HorizontalAlignment', 'right', ...
'String', 'Last Channel' ...
);
...
'Style', 'edit', ...
'Units', 'Normalized', ...
'Position', [0.478 0.62 0.04 0.025], ...
...
'Style', 'edit', ...
'Units', 'Normalized', ...
'Position', [0.5215 0.62 0.1 0.025], ...
...
'Style', 'Pushbutton', ...
'Units', 'Normalized', ...
'Position', [0.62725 0.62 0.035 0.025], ...
'String', 'Preview', ...
...
'Style', 'edit', ...
'Units', 'Normalized', ...
'Position', [0.6665 0.62 0.15 0.025], ...
...
'Style', 'text', ...
'Units', 'Normalized', ...
'Position', [0.438 0.53 0.035 0.02] ,...
'HorizontalAlignment', 'right', ...
'String', 'File name' ...
);
...
'Style', 'edit', ...
'Units', 'Normalized', ...
'Position', [0.478 0.53 0.04 0.025], ...
...
'Style', 'edit', ...
'Units', 'Normalized', ...
'Position', [0.5215 0.53 0.1 0.025], ...
...
'Style', 'Pushbutton', ...
'Units', 'Normalized', ...
'Position', [0.62725 0.53 0.035 0.025], ...
'String', 'Preview', ...
...
'Style', 'edit', ...
'Units', 'Normalized', ...
'Position', [0.6665 0.53 0.15 0.025], ...
...
'Style', 'text', ...
'Units', 'Normalized', ...
'Position', [0.438 0.47 0.035 0.02] ,...
'HorizontalAlignment', 'right', ...
'String', 'Motor values' ...
);
...
'Style', 'edit', ...
'Units', 'Normalized', ...
'Position', [0.478 0.47 0.04 0.025], ...
...
'Style', 'text', ...
'Units', 'Normalized', ...
'Position', [0.438 0.44 0.035 0.02] ,...
'HorizontalAlignment', 'right', ...
'String', 'Channels' ...
);
...
'Style', 'edit', ...
'Units', 'Normalized', ...
'Position', [0.478 0.44 0.04 0.025], ...
...
'Style', 'text', ...
'Units', 'Normalized', ...
'Position', [0.5295 0.5 0.035 0.02] ,...
'HorizontalAlignment', 'right', ...
'String', 'Intensities' ...
);
...
'Style', 'text', ...
'Units', 'Normalized', ...
'Position', [0.5295 0.47 0.035 0.02] ,...
'HorizontalAlignment', 'right', ...
'String', 'Date' ...
);
...
'Style', 'text', ...
'Units', 'Normalized', ...
'Position', [0.5295 0.44 0.035 0.02] ,...
'HorizontalAlignment', 'right', ...
'String', 'Times' ...
);
...
'Style', 'text', ...
'Units', 'Normalized', ...
'Position', [0.62725 0.5 0.035 0.02] ,...
'HorizontalAlignment', 'right', ...
'String', 'Detectors' ...
);
...
'Style', 'edit', ...
'Units', 'Normalized', ...
'Position', [0.6665 0.5 0.04 0.025], ...
'Tag', 'defineliteralSPECFilenames', ...
'Enable', 'on', ...
'String', '#@MCADEV' ...
);
...
'Style', 'text', ...
'Units', 'Normalized', ...
'Position', [0.62725 0.47 0.035 0.02] ,...
'HorizontalAlignment', 'right', ...
'String', 'Temperature' ...
);
...
'Style', 'edit', ...
'Units', 'Normalized', ...
'Position', [0.6665 0.47 0.04 0.025], ...
...
'Style', 'text', ...
'Units', 'Normalized', ...
'Position', [0.62725 0.44 0.035 0.02] ,...
'HorizontalAlignment', 'right', ...
'String', 'RingCurrent' ...
);
...
'Style', 'edit', ...
'Units', 'Normalized', ...
'Position', [0.6665 0.44 0.04 0.025], ...
'Tag', 'defineliteralSPECRingCurrent', ...
'Enable', 'on', ...
'String', '#@RC' ...
);

h.textliteralsSPECMythenEnergy = uicontrol( ...
'Parent', h.CreateDiffpanel, ...
'Style', 'text', ...
'Units', 'Normalized', ...
'Position', [0.725 0.5 0.055 0.02] ,...
'HorizontalAlignment', 'right', ...
'String', 'MYTHEN2ENERGY' ...
);

h.defineliteralSPECMythenEnergy = uicontrol( ...
'Parent', h.CreateDiffpanel, ...
'Style', 'edit', ...
'Units', 'Normalized', ...
'Position', [0.783 0.5 0.07 0.025], ...
'Tag', 'defineliteralSPECFileMYTHEN2ENERGY', ...
'Enable', 'on', ...
'String', '#@MYTHEN2_ENERGY' ...
);

h.textliteralsSPECMythenThreshold = uicontrol( ...
'Parent', h.CreateDiffpanel, ...
'Style', 'text', ...
'Units', 'Normalized', ...
'Position', [0.725 0.47 0.055 0.02] ,...
'HorizontalAlignment', 'right', ...
'String', 'MYTHEN2THRESHOLD' ...
);

h.defineliteralSPECMythenThreshold = uicontrol( ...
'Parent', h.CreateDiffpanel, ...
'Style', 'edit', ...
'Units', 'Normalized', ...
'Position', [0.783 0.47 0.07 0.025], ...
'Tag', 'defineliteralSPECMYTHEN2THRESHOLD', ...
'Enable', 'on', ...
'String', '#@MYTHEN2_THRESHOLD' ...
);

h.textliteralsSPECMYTHEN2CALIB = uicontrol( ...
'Parent', h.CreateDiffpanel, ...
'Style', 'text', ...
'Units', 'Normalized', ...
'Position', [0.725 0.44 0.055 0.02] ,...
'HorizontalAlignment', 'right', ...
'String', 'MYTHEN2CALIB' ...
);

h.defineliteralSPECMYTHEN2CALIB = uicontrol( ...
'Parent', h.CreateDiffpanel, ...
'Style', 'edit', ...
'Units', 'Normalized', ...
'Position', [0.783 0.44 0.07 0.025], ...
'Tag', 'defineliteralSPECMYTHEN2CALIB', ...
'Enable', 'on', ...
'String', '#@MYTHEN2_CALIB' ...
);


% Title for creating diffractometer
h.textdiffcreator = uicontrol( ...
'Parent', h.CreateDiffpanel, ...
'Style', 'text', ...
'Units', 'Normalized', ...
'FontWeight', 'bold' ,...
'Position', [0.44 0.38 0.4 0.02] ,...
'HorizontalAlignment', 'left', ...
'String', 'Define and create diffractometer file' ...
);
...
'Style', 'Pushbutton', ...
'Units', 'Normalized', ...
'Position', [0.7975 0.355 0.06 0.025], ...
...
'Style', 'checkbox', ...
'Units', 'Normalized', ...
'Position', [0.7475 0.3575 0.045 0.02], ...
...
'Units', 'Normalized', ...
'Position', [0.44 0.17 0.4575 0.1675], ...
'Rowname', [],...
...
'Units', 'Normalized', ...
'Position', [0.44 0.01 0.17 0.1475], ...
'ColumnWidth', {120 160}, ...
...
'Style', 'Pushbutton', ...
'Units', 'Normalized', ...
'Position', [0.725 0.06 0.07 0.025], ...
...
if size(motortabledata_tmp,2) ~= 1
    ...
    if size(motortabledata_tmp,1) == 1
        ...
        modedata = cell(size(motortabledata{1},2),1);
...
% assignin('base','motortabledata',motortabledata)
% Set table data
if size(motortabledata,2) == 1
    set(h.tablemotornames, 'data',[motortabledata{1}' modedata])
    set(h.tablemotornames, 'Position',[0.44 0.17 0.116 0.1675])
    set(h.tablemotornames, 'ColumnWidth',{80 130})
    ...
    % Get diffractometer motor names
    diffmotors = h.MotorNames{1}';
elseif size(motortabledata,2) == 2
    set(h.tablemotornames, 'data',[motortabledata{1}' modedata motortabledata{2}' modedata])
    set(h.tablemotornames, 'Position',[0.44 0.17 0.23 0.1675])
    set(h.tablemotornames, 'ColumnWidth',{80 130 80 130})
...
elseif size(motortabledata,2) == 3
    ...
    set(h.tablemotornames, 'Position',[0.44 0.17 0.344 0.1675])
...
elseif size(motortabledata,2) == 4
    ...
    set(h.tablemotornames, 'Position',[0.44 0.17 0.4575 0.1675])
...
Diffractometer.VirtualMotors.x = char(h.usermotornames(5,2));
Diffractometer.VirtualMotors.y = char(h.usermotornames(6,2));
Diffractometer.VirtualMotors.z = char(h.usermotornames(7,2));
...
if SPECFormatCheck == 1
    ...
    Diffractometer.ImportLiterals.FormatFileName = get(h.defineFormatSPECFilename,'String');
...
msgbox({'Diffractometer file created'});
