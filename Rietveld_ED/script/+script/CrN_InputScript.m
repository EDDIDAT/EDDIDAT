...
config.configParameter('DummyPosition',...
	'Value', [30.54],...	%; 20.98; 29.67; 36.34; 41.96; 46.91; 51.39
	'LowerConstraint', [30.2],...	%; 20.68; 29.37; 36.04; 41.66; 46.61; 51.09
	'UpperConstraint', [30.8],...	%; 21.28; 29.97; 36.64; 42.26; 47.21; 51.69
	'Refinable', false);
...
config.configParameter('Density',...
	'Value', S.Density);
load(fullfile(rvpath,'data','Physics','CrN_absorption_XCOM.mat'));
