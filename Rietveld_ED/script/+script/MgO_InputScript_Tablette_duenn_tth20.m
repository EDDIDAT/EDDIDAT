...
config.configParameter('DummyPosition',...
	'Value', [14.4; 25.34; 27.94; 28.43],...
	'LowerConstraint', [14.20; 25.1; 27.60; 28.2],...
	'UpperConstraint', [14.60; 25.5; 28.20; 28.65],...
	'Refinable', false);
...
config.configParameter('P_Size',...
	'Value', [0.021343722],... %0.0458752946,0.0348190465,0.0273706272,0.021343722
	'LowerConstraint', [0.0212974237],...
	'UpperConstraint', [2],...
	'Refinable', false);
config.configParameter('P_Size_Instr',...
	'Value', [0.021343722],... %0.0458752946,0.0348190465,0.0273706272,0.021343722
	'LowerConstraint', [0.021343722],...
	'UpperConstraint', [2],...
	'Refinable', false);
config.configParameter('U_Strain',...
	'Value', [0.0001035043],... %0.0001903902;0.0001579451;0.000117234;0.000094514
	'LowerConstraint', [0.0001035043],...
	'UpperConstraint', [1],...
	'Refinable', false);
...
config.configParameter('Y_Strain',...
	'Value', [0.0040673167],... %0.0009895165;0.0011955441;0.0026694852;0.0029200925
	'LowerConstraint', [0.0040673167],...
	'UpperConstraint', [1],...
	'Refinable', false);
