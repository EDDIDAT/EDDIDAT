...
config.configParameter('DummyPosition',...
	'Value', [14.86; 17.91; 25.28; 34.82],...	%17; 19; 20.17; 24.4; 28.85; 34; 35.5; 41.1; 46.2; 50.6
	'LowerConstraint', [14.7; 17.70; 25; 34.6],...	%16.70; 18.70; 20; 24; 28.50; 33.80; 35.2; 40.9; 45.8; 50.3
	'UpperConstraint', [15; 18.20; 25.5; 35],...	%17.30; 19.30; 20.5; 24.70; 29.10; 34.30; 35.8; 41.4; 46.5; 50.8
	'Refinable', false);
...
config.configParameter('P_Size',...
	'Value', [0.0266521448],... %0.0458752946,0.0348190465,0.0273706272,0.021343722
	'LowerConstraint', [0.0266521448],...
	'UpperConstraint', [2],...
	'Refinable', false);
...
config.configParameter('U_Strain',...
	'Value', [0.0001385268],... %0.0001903902;0.0001579451;0.000117234;0.000094514
	'LowerConstraint', [0.0001385268],...
	'UpperConstraint', [1],...
	'Refinable', false);
...
config.configParameter('Y_Strain',...
	'Value', [0.0039787613],... %0.0009895165;0.0011955441;0.0026694852;0.0029200925
	'LowerConstraint', [0.0039787613],...
	'UpperConstraint', [1],...
	'Refinable', false);
