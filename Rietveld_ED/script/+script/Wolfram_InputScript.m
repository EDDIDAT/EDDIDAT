...
psiTmp = [0;20;45;60;70;75;80;81;82;83;84;85;86;87;88;89;20;45;60;70;75;80;81;82;83;84;85;86;87;88;89];
% psiTmp = [0;87;85;85;87;0;0;85;85];
...
DEK_S_Tmp = [-7.004e-007 3.185e-006;...
	-7.004e-007 3.185e-006;...
% 	-7.004e-007 3.185e-006;...
% 	-7.004e-007 3.185e-006;...
% 	-7.004e-007 3.185e-006;...
% 	-7.004e-007 3.185e-006;...
...
config.configParameter('Density',...
	'Value', 19.25);
load(fullfile(rvpath,'data','Physics','W_absorption_FFAST'));
...
config.configParameter('SF_a',...
	'Value', Atomdata(159,[1 3 5 7]));
config.configParameter('SF_b',...
	'Value', Atomdata(159,[2 4 6 8]));
config.configParameter('SF_c',...
	'Value', Atomdata(159,9));
...
load(fullfile(rvpath,'data','Physics','anomalousScattering','Wf1.mat'))
load(fullfile(rvpath,'data','Physics','anomalousScattering','Wf2.mat'))
