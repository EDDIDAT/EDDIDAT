classdef Poly4 < rietveld.func.spec.diffpeaks.strain.StrainInterface
...
% 			disp(tau)
			sigmatau = (phase.StressCoef1 + ...
				phase.StressCoef2.* tau + ...
				2.* phase.StressCoef3.* tau.^2 + ...
				6.* phase.StressCoef4.* tau.^3);
