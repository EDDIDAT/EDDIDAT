classdef Mod4 < rietveld.func.spec.diffpeaks.strain.StrainInterface
	...
	methods (Access = public)
		...
		% acm wird aus Effizienzgruenden direkt uebergeben
			...
			sigmatau = phase.StressCoef1./(phase.StressCoef5.*tau + 1) + ...
				phase.StressCoef2.*tau./(phase.StressCoef5.*tau + 1).^2 + ...
				2.* phase.StressCoef3.*tau.^2./(phase.StressCoef5.*tau + 1).^3 + ...
				6.* phase.StressCoef4.*tau.^3./(phase.StressCoef5.*tau + 1).^4;
