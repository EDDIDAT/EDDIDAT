classdef Poly3 < rietveld.func.spec.diffpeaks.strain.StrainInterface
...
% 			sigmatau = phase.StressCoef1 + phase.StressCoef2.* tau + 2.* phase.StressCoef3.* tau.^2;
			...
			eps_hkl = ((sind(spec.Psi)^2) * general.DEK_S2 + 2 * general.DEK_S1) .* (phase.StressCoef1 + phase.StressCoef2.* tau + 2.* phase.StressCoef3.* tau.^2);% sigmatau;
		end
