classdef Mod5 < rietveld.func.spec.diffpeaks.strain.StrainInterface
	...
	methods (Access = public)
		...
		% acm wird aus Effizienzgruenden direkt uebergeben
			...
			sigmatau = phase.StressCoef1./(phase.StressCoef6.*tau + 1) + ...
				phase.StressCoef2.*tau./(phase.StressCoef6.*tau + 1).^2 + ...
				2.* phase.StressCoef3.*tau.^2./(phase.StressCoef6.*tau + 1).^3 + ...
				6.* phase.StressCoef4.*tau.^3./(phase.StressCoef6.*tau + 1).^4 + ...
				24.* phase.StressCoef5.*tau.^4./(phase.StressCoef6.*tau + 1).^5;
...
% 				'SpecDep', false);
			...
			obj.addParameter(pc, 'StressCoef4',...
				...
				'PhaseDep', true,...
				'SpecDep', false);
			obj.addParameter(pc, 'StressCoef5',...
				'Category', 'Peaks',...
				'ParamSize', [1, 1],...
				'Constant', false,...
				'PhaseDep', true,...
				'SpecDep', false);
			obj.addParameter(pc, 'StressCoef6',...
				'Category', 'Peaks',...
				'ParamSize', [1, 1],...
				'Constant', false,...
				'PhaseDep', true,...
