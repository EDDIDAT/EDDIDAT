% Gibt einen IP wieder, der Anwendung bei zweidimensionalen Funktionen, die
% geplotten werden sollen, findet.
% Input: none
% Output: ip, InputParser, inputParser
function ip = PlottableFunction3D()
...
%% (* Darstellung *)
    ...
    ip.addParamValue('PlotOptions',...
        {@Tools.Plotting.DefaultPlotOptions3D},...
