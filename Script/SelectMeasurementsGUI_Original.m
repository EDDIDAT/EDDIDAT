...
% restrictions type "[]"
if strcmp(P.Diffsel,'EDDI') || strcmp(P.Diffsel,'LIMAX-160') || strcmp(P.Diffsel,'LIMAX-70')
    ShrinkEnergyRange = [P.EnergyRange];  % TiCN [24 73], Al2O4 [14 66], WC [];
elseif strcmp(P.Diffsel,'LEDDI')
...
% ShrinkEnergyRange
% assignin('base','MeasurementGUI',Measurement)
