function [Psidata] = EDDIPsiDataTCHSaveMod(DiffractionLines)
    for k = 1:size(DiffractionLines,1)
        for l = 1:size(DiffractionLines{k},2)
            ...
            Psidata.x_achse(k,l) = DiffractionLines{k,1}(l).Motors.x_achse;
            Psidata.y_achse(k,l) = DiffractionLines{k,1}(l).Motors.y_achse;
            Psidata.z_achse(k,l) = DiffractionLines{k,1}(l).Motors.z_achse;
