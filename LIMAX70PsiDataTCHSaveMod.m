function [Psidata] = LIMAX70PsiDataTCHSaveMod(DiffractionLines)
    for k = 1:size(DiffractionLines,1)
        for l = 1:size(DiffractionLines{k},2)
            ...
            Psidata.x_achse(k,l) = DiffractionLines{k,1}(l).Motors.XE;
            Psidata.y_achse(k,l) = DiffractionLines{k,1}(l).Motors.YE;
            Psidata.z_achse(k,l) = DiffractionLines{k,1}(l).Motors.ZE;
