...
T.expression1 = 'D\d{6}\w{1}1(?!\w)';	% 1st row containing the values of the lattice parameter and the # of the pdf card
T.expression2 = 'D\d{6}\w{1}2(?!\w)';	% 2nd row containing the values of the angles (alpha, beta, gamma)
T.expression3 = 'D\d{6}\w{1}3(?!\w)';	% 3rd row containing the spacegroup and spacegroup number
T.expression4 = 'D\d{6}\w{1}4(?!\w)';	% 3rd row containing the density and molecular weight
T.expression5 = 'D\d{6}\w{1}5(?!\w)';	% needed for indexing
T.expression6 = 'D\d{6}\w{1}6(?!\w)';	% 6th row containing the name of the Element
T.expression7 = 'D\d{6}\w{1}7(?!\w)';	% 7th row containing the symbol of the Element
T.expression8 = 'D\d{6}\w{1}G(?!\w)';	% needed for indexing
T.expression9 = 'D\d{6}\w{1}I(?!\w)';	% 8th row containing the values of d-spacing, relative intensity and hkl-values
